...
public class TestTaskExtractDepAts extends TaskTest<TaskExtractDepAts>
{
    ...
    public void runTask() throws IOException
    {
        ...
        project.getConfigurations().maybeCreate("test_at").getDependencies().add(new DefaultSelfResolvingDependency((FileCollectionInternal) project.files(modWithAtJar)));
